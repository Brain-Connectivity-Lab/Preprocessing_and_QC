...
for subji = 1:length(subjfolder)
    ...
    matlabbatch{subji}.spm.util.imcalc.input{2,1} = fullfile('F:\fMRI_QC\fmri-open-qc-rest_bias_corrected', subjfolder(subji).name, 'anat', ['wc3' subjfolder(subji).name '_ses-01_run-01_T1w.nii']);
    matlabbatch{subji}.spm.util.imcalc.output = 'mask_CSF_99';
